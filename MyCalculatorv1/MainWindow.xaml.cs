...
namespace MyCalculatorv1
{
    public partial class MainWindow : Window
    {
        ...
        private void result()
        {
            ...
            if (op == "+")
            {
                tb.Text += "=" + addition(op1,op2);
            }
            else if (op == "-")
            {
                tb.Text += "=" + substraction(op1,op2);
            }
            else if (op == "*")
            {
                tb.Text += "=" + multipication(op1,op2);
            }
            else
            {
                tb.Text += "=" + division(op1,op2);
            }
        }
        ...
        public double multipication(double op1, double op2)
        {
            return op1 * op2;
        }
